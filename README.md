...
Pre-requisites:
GHOST runs on windows and has been tested with Meta headsets, we recommend the Meta Quest 3 headset.


To set up this project on your computer:
1. Download Unity Hub if not already installed (https://unity.com/download)
2. Open the project in Unity Hub and download the required Unity version (e.g. 6000.1.7f1). If you don't see this particular version as an option, you can download it from the Unity archive (https://unity.com/releases/editor/archive). Make sure to select "Android Build Support" and its children from the "Platforms" menu.
