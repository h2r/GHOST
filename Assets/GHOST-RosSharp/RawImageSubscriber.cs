...
namespace RosSharp.RosBridgeClient
{
    public class RawImageSubscriber : UnitySubscriber<MessageTypes.Sensor.Image>
    {
        ...
        private MessageTypes.BuiltinInterfaces.Time timestamp_proc; // timestamp of message being processed
        ...
        protected override void Start()
        {
            ...
            globalData[0] = 1.0f; // Test to make sure a value is initialized 
            timestamp_synced = 0d;
        ...
        public float[] getDepthArr()
        {
            if (globalData is null)
                return new float[1];
            UnityEngine.Debug.Log("globalData.Length: " + globalData.Length);
